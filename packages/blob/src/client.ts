...
export interface ClientPutCommandOptions
  extends CommonCreateBlobCommandOptions {
  /**
...
export interface UploadOptions extends CommonCreateBlobCommandOptions {
  /**
 ...
 * Detailed documentation can be found here: https://khulnasoft.com/docs/storage/khulnasoft-blob/using-blob-sdk#client-uploads
 *
 * If you want to upload from your server instead, check out the documentation for the put operation: https://khulnasoft.com/docs/storage/khulnasoft-blob/using-blob-sdk#upload-a-blob
 *
