...
/**
 * Creates a folder in your store. Khulnasoft Blob has no real concept of folders, our file browser on Khulnasoft.com displays folders based on the presence of trailing slashes in the pathname. Unless you are building a file browser system, you probably don't need to use this method.
 *
