  ...
  return (
    <>
      ...
      <p>
        ...
        to a{' '}
        <a href="https://khulnasoft.com/docs/concepts/functions/serverless-functions">
          Serverless Function
        </a>
        .
      </p>
      <p>
        Note: When deployed on Khulnasoft, there&apos;s a 4.5 MB file upload limit.
      </p>
      <FormDataUpload action="/khulnasoft/blob/api/app/formdata/serverless" />
    </>
  );
}
