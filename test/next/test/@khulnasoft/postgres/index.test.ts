...
test.describe('@khulnasoft/postgres', () => {
  test.describe('app directory', () => {
    test.describe('client', () => {
      test.describe('api', () => {
        test('edge', async ({ request }) => {
          const res = await request.get('api/khulnasoft/postgres/app/client/edge');
          expect(await res.json()).toEqual(expectedRows);
        });
        test('node', async ({ request }) => {
          const res = await request.get('api/khulnasoft/postgres/app/client/node');
          expect(await res.json()).toEqual(expectedRows);
        });
      });
      test.describe('page', () => {
        test('edge', async ({ page }) => {
          ...
          // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- [@khulnasoft/style-guide@5 migration]
    ...
    test.describe('pool', () => {
      test.describe('api', () => {
        test('edge', async ({ request }) => {
          const res = await request.get('api/khulnasoft/postgres/app/pool/edge');
          expect(await res.json()).toEqual(expectedRows);
        });
        test('node', async ({ request }) => {
          const res = await request.get('api/khulnasoft/postgres/app/pool/node');
          expect(await res.json()).toEqual(expectedRows);
        });
      });
      test.describe('page', () => {
  ...
  test.describe('pages directory', () => {
    test.describe('client', () => {
      test('edge', async ({ request }) => {
        const res = await request.get('api/khulnasoft/postgres/pages/client/edge');
        expect(await res.json()).toEqual(expectedRows);
      });
      test('node', async ({ request }) => {
        const res = await request.get('api/khulnasoft/postgres/pages/client/node');
        expect(await res.json()).toEqual(expectedRows);
      });
    });
    test.describe('pool', () => {
      test('edge', async ({ request }) => {
        const res = await request.get('api/khulnasoft/postgres/pages/pool/edge');
        expect(await res.json()).toEqual(expectedRows);
      });
      test('node', async ({ request }) => {
        const res = await request.get('api/khulnasoft/postgres/pages/pool/node');
        expect(await res.json()).toEqual(expectedRows);
      });
    });
  });
